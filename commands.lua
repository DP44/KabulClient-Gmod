...
concommand.Add('kc_help', function()
	MsgC(pS.g_pDefaultColor, '============================================================\n');
	MsgC(color_white,        'kc_help               - Shows this message.\n'                 );
	MsgC(color_white,        'kc_config             - Shows which features are toggled.\n'   );
	MsgC(pS.g_pDefaultColor, '------------------------------------------------------------\n');
	MsgC(color_white,        'kc_visuals_name        - Displays the player\'s name.\n'       );
	MsgC(color_white,        'kc_visuals_health      - Displays the player\'s health.\n'     );
	MsgC(color_white,        'kc_visuals_distance    - Displays the distance between you\n'  );
	MsgC(color_white,        '                         and the player.\n'                    );
	MsgC(color_white,        'kc_visuals_flatchams   - Toggles whether to render without\n'  );
	MsgC(color_white,        '                         lighting or to render with it.\n'     );
	MsgC(color_white,        'kc_visuals_fullbright  - Toggles fullbright.\n'                );
	MsgC(color_white,        'kc_visuals_propchams   - Renders prop chams.\n'                );
	MsgC(color_white,        '                         RED   - Attack prop.\n'               );
	MsgC(color_white,        '                         BLUE  - Defense prop.\n'              );
	MsgC(color_white,        '                         GREEN - Normal prop / Undetermined.\n');
	MsgC(color_white,        'kc_visuals_propinfo    - Draw prop information.\n'             );
	MsgC(color_white,        'kc_visuals_playerchams - Renders player chams.\n'              );
	MsgC(color_white,        'kc_visuals_healthbar   - Draws a bar representing player HP.\n');
	MsgC(color_white,        'kc_visuals_tracers     - Display tracers from the cursor to\n' );
	MsgC(color_white,        '                         each player actively rendered.\n'     );
	MsgC(color_white,        'kc_visuals_trajectory  - Shows a trajectory on all players\n'  );
	...
	MsgC(color_white,        'kc_visuals_headbeams   - Renders a beam from the player\'s\n'  );
...
concommand.Add('kc_config', function()
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.Name = ', pCache.Visuals.Name, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.Health = ', pCache.Visuals.Health, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.Distance = ', pCache.Visuals.Distance, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.FlatChams = ', pCache.Visuals.FlatChams, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.HealthBar = ', pCache.Visuals.HealthBar, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.PlayerChams = ', pCache.Visuals.PlayerChams, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.Fullbright = ', pCache.Visuals.Fullbright, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.PropChams = ', pCache.Visuals.PropChams, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.PropInfo = ', pCache.Visuals.PropInfo, '\n')
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Visuals.Tracers = ', pCache.Visuals.Tracers, '\n')
...
concommand.Add('kc_debug_dump_hooks', function()
	PrintTable(hook.GetTable())
end)

concommand.Add('kc_debug_dump_netvars', function()
...
concommand.Add('kc_misc_hitmarker', function()
	...
	MsgC(pS.g_pDefaultColor, '[KabulClient]', color_white, ' pCache.Misc.Hitmarker = ', pCache.Misc.Hitmarker, '\n')
end)
